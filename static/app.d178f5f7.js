...
},{"./bundle-url":"../node_modules/parcel/src/builtins/bundle-url.js"}],"../node_modules/markmap/view.mindmap.css":[function(require,module,exports) {
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"../node_modules/markmap/view.mindmap.css":"../node_modules/markmap/view.mindmap.css","_css_loader":"../node_modules/parcel/src/builtins/css-loader.js"}],"../node_modules/remarkable/lib/common/entities.js":[function(require,module,exports) {
...
},{"./lib/":"../node_modules/remarkable/lib/index.js"}],"../node_modules/markmap/parse.markdown.js":[function(require,module,exports) {
...
},{"remarkable":"../node_modules/remarkable/index.js"}],"../node_modules/markmap/transform.headings.js":[function(require,module,exports) {
...
},{}],"../node_modules/markmap/d3-flextree.js":[function(require,module,exports) {
var define;
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
...
},{"d3":"../node_modules/d3/d3.js"}],"../node_modules/markmap/view.mindmap.js":[function(require,module,exports) {
var define;
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
...
},{"d3":"../node_modules/d3/d3.js"}],"mapview.js":[function(require,module,exports) {
'use strict';
...
var _parseMarkdown = require('markmap/parse.markdown.js');

var _parseMarkdown2 = _interopRequireDefault(_parseMarkdown);

var _transformHeadings = require('markmap/transform.headings.js');

var _transformHeadings2 = _interopRequireDefault(_transformHeadings);

var _d = require('d3');

var _d2 = _interopRequireDefault(_d);

require('markmap/d3-flextree.js');

var _viewMindmap = require('markmap/view.mindmap.js');

var _viewMindmap2 = _interopRequireDefault(_viewMindmap);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mapview = document.querySelector('#mapview'); // src/mapview.js
...
exports.default = {
  update: function update(text) {
    ...
    var headings = (0, _parseMarkdown2.default)(text);
    var data = (0, _transformHeadings2.default)(headings);

    if (markmap === null) {
      markmap = new _viewMindmap2.default('#mapview', data, mindmapOpt);
    } else {
      markmap.setData(data).set({ duration: 0 }).update();
    }
  }
};
},{"markmap/parse.markdown.js":"../node_modules/markmap/parse.markdown.js","markmap/transform.headings.js":"../node_modules/markmap/transform.headings.js","d3":"../node_modules/d3/d3.js","markmap/d3-flextree.js":"../node_modules/markmap/d3-flextree.js","markmap/view.mindmap.js":"../node_modules/markmap/view.mindmap.js"}],"../node_modules/parseuri/index.js":[function(require,module,exports) {
/**
 * Parses an URI
 *
...
},{"./url":"../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../node_modules/socket.io-parser/index.js","./manager":"../node_modules/socket.io-client/lib/manager.js","debug":"../node_modules/debug/src/browser.js","./socket":"../node_modules/socket.io-client/lib/socket.js"}],"socket.js":[function(require,module,exports) {
'use strict';
...
exports.default = {
  ...
  receiveUpdate: function receiveUpdate(cb) {
...
var editor = document.querySelector('#editor'); // src/app.js

editor.addEventListener('input', function (e) {
  var text = editor.innerText.trim();
  _socket2.default.update(text);
  _mapview2.default.update(text);
});

_socket2.default.receiveUpdate(function (text) {
  editor.innerText = text;
  _mapview2.default.update(text);
});
},{"./app.css":"app.css","./mapview":"mapview.js","./socket":"socket.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/app.d178f5f7.map